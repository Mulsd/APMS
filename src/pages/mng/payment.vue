    ...
    >
      <el-form :model="formData" label-width="120px">
        ...
        <el-form-item label="项目">
          <el-input v-model="formData.proj" disabled/>
        </el-form-item>
        <el-form-item label="委托公司" >
          <el-input v-model="formData.company" disabled/>
        </el-form-item>
        <el-form-item label="业务">
          <el-input v-model="formData.order" disabled/>
        </el-form-item>
        <el-form-item label="负责人">
          <el-input v-model="formData.assign" disabled/>
        </el-form-item>
        <el-form-item label="镜头">
          <el-input
            v-model="formData.shot" disabled/>
        </el-form-item>
        ...
        <el-form-item label="状态">
          <el-select v-model="formData.tag" placeholder="请选择状态" disabled>
        ...
        <el-form-item label="备注">
          <el-input v-model="formData.note" type="textarea" disabled/>
        </el-form-item>
      </el-form>
      <template #footer>
